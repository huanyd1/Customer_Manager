...
<body>
            ...
            <div class="staff">
                <div class="top-staff">
                    ...
                    <div class="top-btn-staff">
                        <div class="not-published inline" id="published">
                            <a class="a-not-published a-btn" href="add_customer.php">
                ...
                <form class="form-loc" action="" name="search_form_filter" id="search_form_filter" method="get" onsubmit="javascript: submitnv();return false;">
                    <select class="select-room" name="reference" id="reference">
                        ...
                        <option value="46">Tên Khách Hàng</option>
                    </select>
                    <div class="search">
  ...
  <script>
    ...
    const headers = ["Mã Khách Hàng", "Tên Khách Hàng", "Ảnh", "Địa Chỉ", "Tổng Giá Trị Đơn", "Số Hợp Đồng", "Số ĐT", "Email", "Trạng Thái", "Tùy Chọn"];
    const rows = [];
    let idStaff = ""
    console.log(data);
